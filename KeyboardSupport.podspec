...
s.description      = <<-DESC
KeyboardSupport provides easy navigation between text inputs via and/or with the keyboard's "Return" key. Protocols are provided for easy keyboard dismissal and scrolling.
                        DESC
